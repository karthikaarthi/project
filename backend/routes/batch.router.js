...
const {createBatch, getAllBatch, getBatchById, updateBatch, deleteBatch, getTotalBatches }= require("../controllers/batch.controller");
...
router.post("/", verifyToken, checkRole(["Admin"]),createBatch)
      ...
      .get("/total-batches", getTotalBatches)
